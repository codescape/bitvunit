...
Below you can find a list of all changes applied to the library through its different releases. This list will be updated whenever there are new functions or improvements being introduced or known bugs corrected.

Hide and show details to releases in clicking on the release you are interested in:

h3(release#r09). Release 0.9 (_who knows?_)

_nothing yet_

h3(release#r08). Release 0.8 (2013-05-25)
...
** updated commons-io from version 2.1 to 2.4
** updated selenium from version 2.20.0 to 2.33.0
** updated hamcrest-core from version 1.2.1 to 1.3
** updated htmlunit from version 2.9 to 2.12
** updated xmlunit from version 1.3 to 1.4
* improved templates with better implementation instructions

h3(release#r07). Release 0.7 (2012-03-17)
