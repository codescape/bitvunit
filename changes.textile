...
h2(release#r04). Release 0.4 (...)

* added HtmlPageUtil to create HtmlPage objects from String, Reader and InputStream instances
* updated Hamcrest functionality
** replaced RuleMatcher and RuleSetMatcher by ComplianceHtmlPageMatcher 
** added ComplianceStringMatcher to test java.lang.String representations of HTML pages
** added ComplianceReaderMatcher to test HTML pages being accessed by java.io.Reader instances
