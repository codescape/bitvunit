...
Below you can find a list of all changes applied to the framework through its different releases. This list will be updated whenever there are new functions being introduced to the framework.
