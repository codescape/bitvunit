...
/**
 * AlternativeTextForImageButtonRule ensures that every image button created through <code>&lt;input type="image"
 * /&gt;</code> within the given HTML document provides an alternative text through it's <code>alt</code> attribute.
 * <p/>
