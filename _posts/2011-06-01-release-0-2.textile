...
The second release of the library ships with some very interesting features that make it easier to use the library for accessibility testing. Continue reading to learn more about these new features. Aside from that the library now has a total number of 16 rules.
