...
To help new users get started with the library the demo project was improved and has been changed to a web project with own pages and tests against these pages. Have a look at the source code of the updated "bitvunit-demo":BitvUnitDemo project to find out more.
