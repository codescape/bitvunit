...
The current release of the framework now depends on the latest version of Commons IO 2.1 and the updated test library JUnit 4.10. The testsuite still shows that all functionality is still working as intended. If there are any problems "Feedback":/feedback is always welcome!
