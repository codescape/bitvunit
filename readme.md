...
If you want to learn other ways of integrating BitvUnit into your project have a look at the tests inside the `bitvunit-samples` project which show alternative usages of the library.
